...
from models.vits import CharactersConfig, Vits, VitsArgs, VitsAudioConfig
import wandb
torch.set_num_threads(24)
wandb.login(key = "db6f204a887bc4436623a37ce6db19522e0069d5")
...
_SENTENCE = "cô gái đi tới chậu hoa và nhổ một vài bông hoa đẹp"
from utils.text.tokenizer import TTSTokenizer
import numpy as np
import torchaudio
tokenizer = TTSTokenizer.init_from_config(config)[0]
token_ids = tokenizer.text_to_ids(_SENTENCE)
token_ids = torch.tensor(token_ids).unsqueeze(0)

encoder = model.speaker_manager
d_vectors = encoder.compute_embedding_from_clip("data\VIVOSSPK33_216.wav")
...
torchaudio.save("output_2.wav", output["model_outputs"].squeeze(1), sample_rate = 16000)